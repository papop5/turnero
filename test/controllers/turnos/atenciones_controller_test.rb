...
class Turnos::AtencionesControllerTest < ActionController::TestCase
  setup do
    @turno = turnos(:one)
  end
  ...
  test "should create turno" do
    assert_difference('Turno.count') do
      post :create, turno: { asunto: @turno.asunto, descripcion: @turno.descripcion }
    end
  ...
  test "should update turno" do
    patch :update, id: @turno, turno: { asunto: @turno.asunto, descripcion: @turno.descripcion }
    assert_redirected_to turno_path(assigns(:turno))
  end
